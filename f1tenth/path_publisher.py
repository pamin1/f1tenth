...
class PathPublisher(Node):
    def __init__(self):
        ...
        # self._load_csv('/home/nvidia/team2TEMP/src/f1tenth/VipPathOptimization/maps/points/debugpointsstart.csv')
        # self._load_csv('/home/nvidia/team2TEMP/src/f1tenth/VipPathOptimization/maps/points/debugpointslook.csv')
        self._load_csv('/home/nvidia/team2TEMP/src/f1tenth/VipPathOptimization/maps/points/points.csv')
